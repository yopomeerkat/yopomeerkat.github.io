...
function (_Component) {
  ...
  function Investment(props) {
    ...
    _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee3() {
      var web3instance, contractInstance, account, _w, _web, _contract;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.prev = 0;
              _context3.prev = 1;
              _w = Object(_components_w3__WEBPACK_IMPORTED_MODULE_6__["default"])(), _web = _w.web3, _contract = _w.contract;
              web3instance = _web;
    ...
    _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee4() {
      var _ref5, _web2, account, _contract2, rate, investWei, investETH, withdrawWei, withdrawETH, allBets, invested, i, eth, addr;
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 4:
              ...
              _contract2 = _ref5.contract;
              console.log("contract:", _contract2);
              _context4.next = 11;
              return _contract2.methods.rates(account).call();

            case 11:
              rate = _context4.sent;
              _context4.next = 14;
              return _contract2.methods.balance(account).call();

            case 14:
              investWei = _context4.sent;
              investETH = _utils_convert__WEBPACK_IMPORTED_MODULE_7__["default"].eth(_web2, investWei, 3);
              _context4.next = 18;
              return _contract2.methods.payoutAmount().call({
                from: account
              });

            case 18:
              withdrawWei = _context4.sent;
              withdrawETH = _utils_convert__WEBPACK_IMPORTED_MODULE_7__["default"].eth(_web2, withdrawWei, 3);
              _context4.next = 22;
              return _contract2.methods.getBets(20).call();
            ...
            case 22:
              ...
              for (i = 0; i < allBets[0].length; i++) {
                ...
                // 	)}, ${allBets[2][i]}`
                // );
                eth = _utils_convert__WEBPACK_IMPORTED_MODULE_7__["default"].eth(_web2, allBets[1][i]);
            ...
            switch (_context5.prev = _context5.next) {
              ...
              case 4:
                ...
                _web3.eth.sendTransaction({
                  ...
                  from: account,
                  value: _utils_convert__WEBPACK_IMPORTED_MODULE_7__["default"].wei(_web3, val)
...
//# sourceMappingURL=index.js.459a5061c5ca2cf853ce.hot-update.js.map