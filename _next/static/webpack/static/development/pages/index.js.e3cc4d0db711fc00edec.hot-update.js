...
function (_Component) {
  ...
  function Investment(props) {
    ...
    _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee3() {
      var _web3Instance, _contractInstance, _account, _w, web3, contract;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              console.log("web3 1:", _web3Instance);
              console.log("contract:", contract);
              console.log("contract:", _contractInstance);
              _context3.next = 10;
            ...
            case 17:
              ...
              Object(_toasts__WEBPACK_IMPORTED_MODULE_5__["toastMessage"])({
                event: "error",
                message: "Fails to load ETH account."
              });
              console.log("web3 3:", _web3Instance);
    ...
    _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee4() {
      var _ref5, web3, contract, _account2, rate, investWei, investETH, withdrawWei, withdrawETH, allBets, invested, i, eth, addr;
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 4:
              ...
              _account2 = _ref5.account;
              console.log("contract2:", contract);
              _context4.next = 11;
              return contract.methods.rates(_account2).call();

            case 11:
              rate = _context4.sent;
              _context4.next = 14;
              return contract.methods.balance(_account2).call();
...
//# sourceMappingURL=index.js.e3cc4d0db711fc00edec.hot-update.js.map